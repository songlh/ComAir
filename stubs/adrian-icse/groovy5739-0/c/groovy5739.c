...
bool DefaultGroovyMethods_removeAll(HashSet * self, int * item, int length)
{
	ArrayList * pArray = (ArrayList *)malloc(sizeof(pArray));
	ArrayList_ArrayList2(pArray, item, length);

	bool bResult = HashSet_removeAll(self, pArray);
...
int main(int argc, char ** argv)
{
	...
	DefaultGroovyMethods_removeAll(set, array, size);
