...
static RegisterPass<ArrayListLoopBBInstrument> X("array-list-instrument",
...
void ArrayListLoopBBInstrument::InstrumentReturn(Instruction *returnInst) {
...
void ArrayListLoopBBInstrument::InstrumentHooks(Function *pFunction, Instruction *loadInst) {
