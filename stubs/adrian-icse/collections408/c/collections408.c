...
bool SetUniqueList_removeAll(SetUniqueList * pList, ArrayList * coll)
{
	bool result = ArrayList_removeAll(pList->collection, coll);
	HashSet_removeAll(pList->set, coll);
	return result;
}
...
int main(int argc, char ** argv)
{
	...
	SetUniqueList_removeAll(uniqueList, toRemove);
